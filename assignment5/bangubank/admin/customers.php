...
$admin_user = new AdminUser($filePath, $pdo, 'database');
                ...
                <div>
                  <button @click="open = !open" type="button"
                    ...
                    <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-sky-100">
                      <span
                        class="font-medium leading-none text-sky-700"><?php echo ucfirst($user->getFirstChar($user->getName())); ?></span>
                    </span>
                    <!-- <img
                    ...
                    <li class="relative flex justify-between px-4 py-5 gap-x-6 hover:bg-gray-50 sm:px-6 lg:px-8">
                      <div class="flex gap-x-4">
                        ...
                        <?php // Array of color classes to be used for users
                            ...
                            ?>
                        <span
                          class="inline-flex items-center justify-center w-12 h-12 rounded-full <?php echo $colors[array_rand($colors)]; ?>">
                        ...
                        <div class="flex-auto min-w-0">
                          <p class="text-sm font-semibold leading-6 text-gray-900">
                            <a
                              href="<?php echo '../admin/customer_transactions.php?email=' . urlencode($customer_email); ?>">
                          ...
                          <p class="flex mt-1 text-xs leading-5 text-gray-500">
                            <a href="<?php echo '../admin/customer_transactions.php?email=' . urlencode($customer_email); ?>"
                              class="relative truncate hover:underline"><?php echo strtolower($customer_email); ?></a>
                          </p>
                        </div>
                      </div>
                    </li>
