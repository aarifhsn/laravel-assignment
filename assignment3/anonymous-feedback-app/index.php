        ...
        <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                ...
                <?php if ($user->isLoggedIn()) {
                    echo '<span class="text-sm font-semibold leading-6 text-gray-900"> Welcome , ' . $user->getUserName() . ' | </span>';
                    echo '<a href="dashboard.php" class="text-sm font-semibold leading-6 text-gray-900">&nbsp; Dashboard <span aria-hidden="true"> | </span></a>';
                    echo '<a href="logout.php" class="text-sm font-semibold leading-6 text-gray-900 text-red-600">&nbsp; Logout <span aria-hidden="true">&rarr;</span></a>';
                } else {
                    echo
                ...
                <div class="mx-auto max-w-md text-center px-">
                    ...
                    <div class="divide-y divide-gray-300/50">
                        ...
                        <div class="pt-8 text-base font-semibold leading-7">
                            ...
                            <p>
                                <a href="feedback.php" class="text-sky-500 hover:text-sky-600">Let's start!</a>
                            </p>
                        </div>
                    </div>
                </div>
